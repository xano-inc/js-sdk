...
var XanoBaseClient = /** @class */ (function () {
    ...
    XanoBaseClient.prototype.startJob = function (args) {
        return this.post("/api:meta/beta/workspace/".concat(args.workspaceId, "/ephemeral/job"), {
            doc: args.doc,
            args: args.args
        }, {
            "Content-Type": content_type_1.XanoContentType.JSON
        });
    };
    XanoBaseClient.prototype.startService = function (args) {
        return this.post("/api:meta/beta/workspace/".concat(args.workspaceId, "/ephemeral/service"), args.doc, {
            "Accept": content_type_1.XanoContentType.JSON,
            "Content-Type": content_type_1.XanoContentType.XanoScript
        });
    };
